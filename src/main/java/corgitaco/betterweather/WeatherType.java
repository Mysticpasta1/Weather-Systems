...
public record WeatherType<T extends Weather>(Codec<T> codec) {
    public static final ResourceKey<Registry<WeatherType<?>>> KEY = ResourceKey.createRegistryKey(new ResourceLocation(BetterWeather.MOD_ID, "weather"));
    ...
    public static final RegistryObject<WeatherType<Snow>> SNOW = register("snow", Snow.CODEC);
    public static final RegistryObject<WeatherType<Sunny>> SUNNY = register("sunny", Sunny.CODEC);
